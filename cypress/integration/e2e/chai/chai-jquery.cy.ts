...
describe('chai-jquery相关命令', () => {
  ...
  context('书写测试用例', () => {
    ...
    it('html', () => {
      ...
      cy.get('[data-test=chai-jquery-desc]').then($el => {
    ...
    it('empty', () => {
      ...
      cy.get('[data-test=chai-jquery-empty]').then($el => {
    ...
    it('exist/not.exist', () => {
      ...
      cy.get('[data-test=chai-jquery-exist]').then($el => {
    ...
    it('checked/not.checked', () => {
      ...
      cy.get('@chai-left').then($el => {
        expect($el).to.be.checked
      })
      cy.get('@chai-right').then($el => {
