...
describe('skip+hook的测试套件', function () {
    ...
    it.skip('跳过的测试套件', function () {
        cy.log('跳过的测试套件');
    });
    it('未跳过的测试用例', function () {
        cy.log('未跳过的测试用例');
    });
});
describe('skip+hook的测试套件2', function () {
    ...
    it.skip('跳过的测试套件1', function () {
        cy.log('跳过的测试套件1');
    });
    it('未跳过的测试用例', function () {
        cy.log('未跳过的测试用例');
    });
    it.skip('跳过的测试套件2', function () {
        cy.log('跳过的测试套件2');
    });
    afterEach(function () {
        cy.log('afterEach');
...
describe('skip+hook的测试套件3', function () {
    ...
    it('未跳过的测试用例1', function () {
        cy.log('未跳过的测试用例');
    });
    it.skip('跳过的测试套件', function () {
        cy.log('跳过的测试套件');
    });
    it('未跳过的测试套件2', function () {
        cy.log('未跳过的测试套件2');
    });
    afterEach(function () {
        cy.log('afterEach');
