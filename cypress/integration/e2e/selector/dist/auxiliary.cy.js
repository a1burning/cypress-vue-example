...
describe('e2e辅助选择方法', function () {
    ...
    context.skip('关于对象的问题', function () {
        it('获取jQuery对象', function () {
            // JQuery<HTMLElement>
            var $el = Cypress.$('#auxId3');
            var classAttr = $el.attr('class') || '';
            cy.log(classAttr);
        });
        it('获取DOM对象', function () {
            // HTMLElement
            var el = Cypress.$('#auxId3')[0];
            var classAttr = el.getAttribute('class') || '';
            cy.log(classAttr);
        });
        it('获取Cypress封装的DOM对象', function () {
    ...
    context.skip('父子关系选择方法', function () {
        // 获取DOM元素的子元素
    ...
    context.skip('兄弟关系选择方法', function () {
        // 获取除自己之外的所有兄弟元素
    ...
    // 对元素进行遍历
    context.skip('元素遍历方法', function () {
        it('jQuery-each', function () {
            var $lis = Cypress.$('#auxiliarySelector li');
